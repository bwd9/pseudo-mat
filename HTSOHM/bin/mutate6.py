...
def mutate(data_path, atom_types, number_of_children, strength, 
    ...
    if 'HV' in bin_dimensions:
        ...
        #HV_step = 1./bins
	#HV_bins = np.arange(0., 1., HV_step)
 
        #freq_HV, edges_HV = np.histogram(HV_values, bins=HV_bins)
    ...
    if 'SA' in bin_dimensions:
        ...
        #SA_step = 5000./float(bins)
	#SA_bins = [0., 500., 1000., 1500.,
        #           2000., 2500., 3000., 3500.,
        #           4000., 4500., 5000.]
    ...
    if 'CH4' in bin_dimensions:
        ...
        #CH4_step = 400./bins
	#CH4_bins = np.arange(0., 400., CH4_step)

        #freq_CH4, edges_CH4 = np.histogram(CH4_values, bins=CH4_bins)
